<?php
	...
	$link = mysqli_connect("localhost","root","1234") or die("<h2>No se encuentra el servidor</h2>");
	...
	mysqli_query("INSERT INTO datos VALUES('','$nombres','$apellidos','$email','$contraseñaUser')",$link) or die("<h2>Error Guardando los datos</h2>");
	echo'
		<script>
